...
# Title: Sarsat1
# Generated: Fri Jun  9 22:28:47 2017
##################################################
...
class sarsat1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Sarsat1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Sarsat1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "sarsat1")
...
def main(top_block_cls=sarsat1, options=None):
