...
# Title: Fo29 1
# Generated: Thu Apr 20 19:41:18 2017
##################################################
...
class fo29_1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Fo29 1")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Fo29 1")
        ...
        self.settings = Qt.QSettings("GNU Radio", "fo29_1")
...
def main(top_block_cls=fo29_1, options=None):
